    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-6 sm:pl-10">
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col justify-between animate-slideLeft">
          ...
          {/* Drawer Header */}
          <div className="p-4 sm:p-5 bg-[#250610] text-white flex items-center justify-between border-b border-brand-900">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-gold-600 text-stone-950 flex items-center justify-center font-bold">
                <ShoppingBag className="w-5 h-5" />
              </div>
              <div>
                <h3 className="font-serif font-bold text-lg text-gold-200">
                  Your Order Tray
                </h3>
            ...
            {orderItems.length > 0 ? (
              <div className="space-y-3">
                ...
                {orderItems.map((item) => (
                  <div
                    key={item.itemKey}
                    className="bg-white p-3.5 rounded-2xl border border-stone-200 shadow-xs flex flex-col justify-between gap-2.5"
                  >
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            {item.variant && (
                              <span className="text-[11px] font-semibold text-brand-900 bg-brand-50 px-1.5 py-0.2 rounded border border-brand-200">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-stone-100">
                      <div className="flex items-center gap-2 bg-stone-100 rounded-lg p-1">
                        <button
                          ...
                          className="w-5 h-5 rounded bg-white shadow-xs flex items-center justify-center text-stone-700 hover:bg-stone-200"
                        >
          ...
          {orderItems.length > 0 && (
            <div className="p-4 sm:p-5 bg-white border-t border-stone-200 shadow-lg space-y-3">
              ...
              <button
                ...
                className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-amber-500 via-gold-500 to-amber-600 text-stone-950 font-extrabold text-sm sm:text-base shadow-lg hover:from-amber-400 hover:to-gold-500 transition-all flex items-center justify-center gap-2 transform active:scale-98 cursor-pointer"
              >
                <Bell className="w-5 h-5 text-stone-950 animate-bounce-subtle" />
